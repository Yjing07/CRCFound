...
class PatchEmbed(nn.Module):
    ...
    """
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768, num_frames=16, tubelet_size=16):
        super().__init__()
...
class ViT(nn.Module):
    def __init__(self, *, image_size=256, image_patch_size=16, frames=16, frame_patch_size=2, num_classes=1, dim=1024, depth=6, heads=8, pool = 'cls', channels = 1, emb_dropout = 0.,
        ...
        self.patch_embed = PatchEmbed(
            img_size=image_size, patch_size=image_patch_size, in_chans=1, embed_dim=dim)
